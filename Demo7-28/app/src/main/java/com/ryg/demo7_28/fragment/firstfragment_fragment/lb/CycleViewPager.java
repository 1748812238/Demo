...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
    ...
    private Lb_ViewPager viewPager;
    private Lb_ViewPager parentViewPager;
    private ViewPagerAdapter adapter;
    private MyViewPagerHandler handler;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager = (Lb_ViewPager) view.findViewById(R.id.viewPager);
        ...
        handler = new MyViewPagerHandler(getActivity()) {
    ...
    public void setData(List<ImageView> views, List<Bean_lb> list, ImageCycleViewListener listener) {
     ...
     *            默认显示位置
     */
    public void setData(List<ImageView> views, List<Bean_lb> list, ImageCycleViewListener listener, int showPosition) {
     ...
     * @return viewPager
     */
    public Lb_ViewPager getViewPager() {
        return viewPager;
    }
     ...
     */
    public void disableParentViewPagerTouchEvent(Lb_ViewPager parentViewPager) {
        if (parentViewPager != null)
